    ...
    <View style={{alignItems: 'center', justifyContent: 'center',flex: 1}}>
        ...
        <Text style={{marginTop: 10, fontSize: 16}}>{randomQuote2}</Text>/
            ...
            <View>
              ...
              <TouchableOpacity activeOpacity={0.6} onPress={() => navigation.navigate("GoalsScreen")}>
                <View style={{ marginTop: 50, marginBottom: 50, borderWidth: 1, width: 200, alignSelf: 'center', padding: 12, borderRadius: 100, backgroundColor: '#fff' }}>
        ...
        <Modal visible={isModalVisible} animationType="slide" transparent={true} onRequestClose={() => setIsModalVisible(false)}>
          ...
          <View style={styles.modalContainer}>
            ...
            <View style={styles.modalContent}>
              ...
              <View style={{
                borderWidth: 1, marginTop: 20, borderRadius: 6, marginBottom: 22, backgroundColor: '#fff', shadowColor: 'black',
